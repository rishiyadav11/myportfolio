...
const Projects = () => {
  ...
  {data.map((elem,index)=>(
     <section key={index} className={`dark:bg-gray-900 border  bg-sky-200 bg-[url(${elem.bgimgsrc})] bg-no-repeat bg-cover w-[80%]  rounded-md`}>
    ...
    <div className="mt-4 md:mt-0 sm:ml-20">
        ...
        <a href={elem.href} target='_blank' className="inline-flex items-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-primary-900">
            Live link
        </a>
    </div>
    </div>

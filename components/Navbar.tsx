...
const Navbar = () => {
  ...
  return (
    <nav className="relative bg-white/50 backdrop-blur-3xl select-none p-2 px-5 flex justify-between items-center max-sm:rounded-b-xl">
      ...
      <div className="flex items-center gap-5 max-sm:w-full max-sm:justify-center z-20 relative">
        ...
        />
        <p className="font-bold  w-80 sm:w-fit ">Rishi Yadav's Portfolio</p>
